document.addEventListener('DOMContentLoaded', function () {
  document.getElementById('signupButton').addEventListener('click', function (event) {
    ...
    function submitForm () {
      const nameInput = document.getElementById('signup_name').value
      const usernameInput = document.getElementById('signup_username').value
...
function updateFormActionAndValidate () {
  const inputValue = document.getElementById('enter_int').value
